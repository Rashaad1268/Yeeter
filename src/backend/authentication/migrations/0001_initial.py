    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_rels_actor', to=settings.AUTH_USER_MODEL)),
                ('target', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_rels_target', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('actor', 'target'), name='unique user relation'),
        ),
    ]
